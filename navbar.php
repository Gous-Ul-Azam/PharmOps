...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=sales_report" class="nav-item"><span class='icon-field'><i class="fa fa-coins"></i></span> Sales Report</a>
				<a href="index.php?page=import_excel" class="nav-item"><span class='icon-field'><i class="fa fa-file"></i></span> Import Excel</a>
